...
#     T = RealType
    x_ = exp.(x)
# computes loglikelihood
    local_lik = HPHawkes.loglik1_cb(d, 
...
@time output, likelihoods = mh(d, 1, 5; sigma_init_scale = [0.066, 0.04, 0.047, 0.042, 0.03], 
    init = [2.5257778680272938,0.6438650580280254,2.921348477274639,0.0019517255026022884,-6.258288444312658], rng=StableRNG(98765))
if rank == 0
    println(likelihoods)
end
...
# init = RealType[2.5257778680272938,0.6438650580280254,2.921348477274639,0.0019517255026022884,-6.258288444312658]
