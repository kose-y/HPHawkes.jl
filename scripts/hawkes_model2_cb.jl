...
RealType = Float32
m = 100_0000 # number of samples, must be a multiple of 8 for now
...
@time output, likelihoods = mh(d, 1, 5; sigma_init_scale = [0.066, 0.04, 0.047, 0.042, 0.03], 
    init = [-4.271055374906369,2.505017688169231,-1.1917072802049045,-1.908899301310454,-0.056930439918434037], rng=StableRNG(98765))
sigma_init_scale = [0.02, 0.015, 0.04, 0.02, 0.007]
init = RealType[-1.1384206817214735,0.11408607579274438,2.538144840978749,0.0019656139189940724,-6.1872176235761955]
